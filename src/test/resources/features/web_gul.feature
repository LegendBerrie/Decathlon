...
Scenario: Verify result input (normal and limits) in Web GUI
  ...
  Scenario Outline: Verify input and score at [Enter result]
    ...
    Examples: Decathlon 100m (Gränser: 5 - 20)
      ...
      | Anna | 100m  | 4.9    | Error          | Under lägsta gränsvärdet  |
      | Anna | 100m  | 20.1   | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon Long jump (Gränser: 0 - 1000)
      ...
      | Anna | Long jump | -1     | Error          | Under lägsta gränsvärdet  |
      | Anna | Long jump | 1001   | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon Shot put (Gränser: 0 - 30)
      ...
      | Anna | Shot put | -1     | Error          | Under lägsta gränsvärdet  |
      | Anna | Shot put | 31     | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon High jump (Gränser: 0 - 300)
      ...
      | Anna | High jump | -1     | Error          | Under lägsta gränsvärdet  |
      | Anna | High jump | 301    | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon 400m (Gränser: 20 - 100)
      ...
      | Anna | 400m  | 19.9   | Error          | Under lägsta gränsvärdet  |
      | Anna | 400m  | 100.1  | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon 110m hurdles (Gränser: 10 - 30)
      ...
      | Anna | 110m hurdles | 9.9    | Error          | Under lägsta gränsvärdet  |
      | Anna | 110m hurdles | 30.1   | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon Discus (Gränser: 0 - 85)
      ...
      | Anna | Discus | -1     | Error          | Under lägsta gränsvärdet  |
      | Anna | Discus | 86     | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon Pole vault (Gränser: 0 - 1000)
      ...
      | Anna | Pole vault | -1     | Error          | Under lägsta gränsvärdet  |
      | Anna | Pole vault | 1001   | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon Javelin (Gränser: 0 - 110)
      ...
      | Anna | Javelin | -1     | Error          | Under lägsta gränsvärdet  |
      | Anna | Javelin | 111    | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Decathlon 1500m (Gränser: 150 - 400)
      ...
      | Anna | 1500m | 149.9  | Error          | Under lägsta gränsvärdet  |
      | Anna | 1500m | 400.1  | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Heptathlon 100m hurdles (Gränser: 10 - 30)
      ...
      | Anna | 100m hurdles | 9.9    | Error          | Under lägsta gränsvärdet  |
      | Anna | 100m hurdles | 30.1   | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Heptathlon 200m (Gränser: 20 - 100)
      ...
      | Anna | 200m  | 19.9   | Error          | Under lägsta gränsvärdet  |
      | Anna | 200m  | 100.1  | Error          | Över högsta gränsvärdet   |
    ...
    Examples: Heptathlon 800m (Gränser: 70 - 250)
      ...
      | Anna | 800m  | 69.9   | Error          | Under lägsta gränsvärdet  |
      | Anna | 800m  | 250.1  | Error          | Över högsta gränsvärdet   |